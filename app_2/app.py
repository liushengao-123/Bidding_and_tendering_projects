...
class PromptManager:
    def __init__(self, file_path="E:\project\优化版本1\\app_2\prompts.yaml"):
...
LLM_KEY_VALUE_MAP = pm.get_prompt("LLM_KEY-VALUE_MAP_2")
SHANGHAI_SYSTEM_PROMPT = pm.get_prompt("SHANGHAI_SYSTEM_PROMPT_2")
